...
### Readability
- **Centered text**: While sometimes visually appealing, centered text is harder to read, especially for those with dyslexia or other cognitive disabilities.
- **Contrast**: Text should have sufficient contrast with its background to be easily readable by all visitors.
