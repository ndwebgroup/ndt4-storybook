...
export default function BannerMosaic(props) {
  ...
  const { bannerWidth, order, imageCount, headingTag, label, title, titleSize = 'default', summary, buttons, buttonList, imageModifiers, backgroundColor, backgroundWidth } = props;
