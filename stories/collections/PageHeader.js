...
export default function PageHeader(props) {
  ...
  container.innerHTML = `
      ${featuredImage ? `<figure class="page-image${layout !== `inset` ? ` bg--dark bg--gradient` : ``}" aria-hidden="true"><img src="/images/placeholder-campus-3-1600x900.jpg" width="1600" height="900" alt=""></figure>` : ''}
