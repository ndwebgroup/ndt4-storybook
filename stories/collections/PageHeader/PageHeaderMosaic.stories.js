...
import PageHeaderMosaic from './PageHeaderMosaic.js';
...
export default {
  title: 'Collections/Page Header/Page Header (Mosaic)',
  component: PageHeaderMosaic,
