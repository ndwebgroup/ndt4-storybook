class SbCollectionsList extends HTMLElement {
  async connectedCallback() {
    ...
    try {
      ...
      for (const e of entries) {
        if (!e.title || !e.title.startsWith('Collections/')) continue;
      ...
      this.innerHTML = '<p>Failed to build collections list.</p>';
      console.error(err);
    }
  }
}
customElements.define('sb-collections-list', SbCollectionsList);